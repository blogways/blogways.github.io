---
layout: post
title: jsl7（3）－Arrays（译）
tags: ['java7', 'jsl7', 'Arrays']
author: Jacky
email: shenyj5@asiainfo.com
image:
description: 
最近突然想看看JVM7规范，本来想从网上直接找找看有没有已经翻译好的，结果下了几个发现跟英文版的大部分都对应不起来，所以打算把自己感兴趣的章节翻译一下，顺便练习下英语了~

我参考的是The Java® Language Specification Java SE 7 Third Edition这个规范来翻译的。
